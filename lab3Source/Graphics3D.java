...
public class Graphics3D {
	 ...
	 * @param c
	 *            The color that is faded towards white.
	 */
	public void printBox(Box b, Color c) {
		Graphics2D g2 = (Graphics2D) GamePanel.getBuffer();
		Ellipse2D e = new Ellipse2D.Double(b.x1, b.y1, b.x2 - b.x1, b.y2 - b.y1);
		GradientPaint gp = new GradientPaint(b.x1, b.y1, Color.white, b.x2,
				b.y2, c, false);
		g2.setPaint(gp);
		g2.fill(e);
	}
	...
	public void printBonus(Box b, Color c) {
		Graphics2D g2 = (Graphics2D) GamePanel.getBuffer();
		Rectangle2D e = new Rectangle2D.Double(b.x1, b.y1, b.x2 - b.x1, b.y2
				- b.y1);
		GradientPaint gp = new GradientPaint(b.x1, b.y1, c, b.x2, b.y2,
				Color.white, false);
		g2.setPaint(gp);
		g2.fill(e);
	}
